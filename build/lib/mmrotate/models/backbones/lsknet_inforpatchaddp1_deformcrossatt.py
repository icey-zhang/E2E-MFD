...
class LSKNet_inforpatchaddp1_deformcrossatt(BaseModule):
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            super(LSKNet_inforpatchaddp1_deformcrossatt, self).init_weights()
    ...
    def forward_features(self, x):
        ...
        outs.append(self.fusion((x_main, x_aux)))
